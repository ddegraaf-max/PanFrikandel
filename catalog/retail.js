...
const RETAIL = [
  ...
  { id: 'mora-frikandellen-5', active: true, top: true, cat: 'klasyki', name: 'Mora Frikandellen Classics · 5 szt.', unit: '5 × 70 g (350 g)', buyEur: 2.15, badge: 'KLASYK', icon: 'frikandel', img: 'mora-frikandellen-5.png',
    ...
    desc: 'Ten frikandel. Oryginalna receptura Mora od 1962 roku — holenderski kuzyn kiełbasy i hot doga: bez skórki, gładki, lekko korzenny. Do frytkownicy, na patelnię lub na grilla — a potem do bułki z curry, majonezem i cebulką: broodje frikandel, czyli holenderski hot dog!',
    details: {
