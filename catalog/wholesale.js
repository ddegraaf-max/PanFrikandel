// ============================================================
//  HORECA-CATALOGUS — /hurt, prijs op aanvraag
//  Kartony horeca, sauzen in grootverpakking, olie en apparatuur.
//  `price` staat er nog (historisch) maar wordt NIET getoond: klanten vragen
//  een offerte aan via het formulier op /hurt. Engelse teksten: locales/products-en.js.
//  Categorie 'boxy' (consumentenboxen) wordt op /hurt niet getoond.
// ============================================================
