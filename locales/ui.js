...
UI.pl = {
  ...
  truckIntro: 'PanFrikandel rusza w trasę w 2027: holenderska frytkownia na kółkach — frytki w rożku z fritessaus, frikandel speciaal, bitterballen, kroket na bułce. Sprawdź, gdzie stoimy, obserwuj nas w socialach albo zaproś nas na swoje wydarzenie.',
  ...
  truckNoStops: 'Startujemy w 2027 — pierwsze lokalizacje ogłosimy wkrótce. Obserwuj nas, żeby niczego nie przegapić.',
  ...
  truckBannerP: 'Food truck PanFrikandel rusza w trasę w 2027 — grafik, mapa i zaproszenia na wydarzenia.',
  ...
  errBot: 'Weryfikacja antyspamowa nie powiodła się — odśwież stronę i spróbuj ponownie.',
  errAiRate: 'Za dużo wiadomości na raz — spróbuj za chwilę.',
  ...
  client: {
    ...
    errGeneric: 'Coś poszło nie tak.', errConn: 'Błąd połączenia. Spróbuj ponownie.', botCheck: 'Potwierdź, że nie jesteś robotem.',
...
UI.en = {
  ...
  truckIntro: 'PanFrikandel hits the road in 2027: a Dutch snackbar on wheels — fries in a cone with fritessaus, frikandel speciaal, bitterballen, kroket on a roll. See where we are, follow us on social media or invite us to your event.',
  ...
  truckNoStops: 'We start in 2027 — the first locations will be announced soon. Follow us so you don\'t miss anything.',
  ...
  truckBannerP: 'The PanFrikandel food truck hits the road in 2027 — schedule, map and event bookings.',
  ...
  errBot: 'The anti-spam check failed — refresh the page and try again.',
  errAiRate: 'Too many messages at once — try again in a moment.',
  ...
  client: {
    ...
    errGeneric: 'Something went wrong.', errConn: 'Connection error. Please try again.', botCheck: 'Please confirm you are not a robot.',
